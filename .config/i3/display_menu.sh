...
if [ $res = "HDMI" ]; then
	xrandr --output HDMI2 --mode 1920x1080 --pos 1366x0 --rotate normal --output HDMI1 --off --output DP1 --off --output eDP1 --primary --mode 1366x768 --pos 0x0 --rotate normal --output VIRTUAL1 --off
fi
